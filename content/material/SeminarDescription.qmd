...
- **Moodle Room:** [TBD](https://elearning.uni-flensburg.de/moodle/course/view.php?id=TBD) 
...
::: {.callout-important}
**Note:** This schedule is subject to change as the course progresses. Announcements will be made via [Moodle](https://elearning.uni-flensburg.de/moodle/course/view.php?id=TBD). 
...
| 9  | 20.11.      | Technology, Innovation, and Trade-Led Development            | In-person |
